...
const MyAppointment = () => {
  ...
  return (
    <div>
        <p className='pb-3 mt-12 font-medium text-zinc-700 border-b-gray'>My Appointment</p>
        <div>
          {
            doctors.slice(0,5 ).map((item,index)=> (
              <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b-gray' key={index}>
                <div>
                ...
                <div></div>   {/* //this div is for the mobile view: Buttons will be on the right side */}
